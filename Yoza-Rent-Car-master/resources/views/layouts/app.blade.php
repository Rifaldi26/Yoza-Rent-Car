    ...
    <header class="sticky top-0 z-40 border-b border-[#e5e9f2] bg-white/95 backdrop-blur">
        <div class="mx-auto flex h-16 max-w-7xl items-center gap-3 px-4">
            ...
            <div class="ml-auto flex items-center gap-2">
                ...
                {{-- Lang Toggle --}}
                <div class="inline-flex items-center gap-1 rounded-lg border border-[#e5e9f2]
                            bg-white px-2.5 py-1.5 text-xs font-semibold">
                    <a href="{{ route('locale.switch', 'id') }}"
                       class="{{ app()->getLocale() === 'id' ? 'text-[#3b6fd4]' : 'text-[#7a8499] hover:text-[#18213a]' }}
                              transition-colors">
                        ID
                    </a>
                    <span class="text-[#c8d0e0]">|</span>
                    <a href="{{ route('locale.switch', 'en') }}"
                       class="{{ app()->getLocale() === 'en' ? 'text-[#3b6fd4]' : 'text-[#7a8499] hover:text-[#18213a]' }}
                              transition-colors">
                        EN
                    </a>
                </div>
