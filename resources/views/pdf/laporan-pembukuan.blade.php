...
<div class="page">
    ...
    <div class="header">
        <div>
            ...
            <div class="brand-sub">Laporan Penjualan Internal</div>
        </div>
        <div class="report-meta">
            <div class="report-title">Laporan Pembukuan</div>
    ...
    <div class="footer">
        <div>
            Yoza Rent Car &bull; Laporan Penjualan Internal &bull; Tahun {{ $tahun }}<br>
